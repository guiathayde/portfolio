export function PrivacyPolicy() {
  return (
    ...
    >
      <h2 style={{ color: 'white' }}>Política Privacidade</h2>
      <p style={{ color: 'white' }}>
        A sua privacidade é importante para nós. É política do guiathayde.dev
        respeitar a sua privacidade em relação a qualquer informação sua que
        possamos coletar no site{' '}
        <a href="https://guiathayde.dev/">guiathayde.dev</a>, e outros sites que
      ...
      <h3 style={{ color: 'white' }}>Compromisso do Usuário</h3>
      <p style={{ color: 'white' }}>
        O usuário se compromete a fazer uso adequado dos conteúdos e da
        informação que o guiathayde.dev oferece no site e com caráter
      ...
      <ul style={{ color: 'white' }}>
        ...
        <li>
          ...
          (softwares) do guiathayde.dev, de seus fornecedores ou terceiros, para
          introduzir ou disseminar vírus informáticos ou quais outros sistemas
          de hardware ou software que sejam capazes de causar danos
          anteriormente mencionados.
        </li>
      </ul>
      <h3 style={{ color: 'white' }}>Mais informações</h3>
      <p style={{ color: 'white' }}>
      ...
      <p style={{ color: 'white' }}>
        Esta política é efetiva a partir de 1 September 2025 18:25
      </p>
    </div>
  );
}
