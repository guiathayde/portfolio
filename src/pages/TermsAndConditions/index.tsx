export function TermsAndConditions() {
  return (
    ...
    >
      <h2 style={{ color: 'white' }}>1. Termos</h2>
      <p style={{ color: 'white' }}>
        Ao acessar ao site <a href="https://guiathayde.dev/">guiathayde.dev</a>,
      ...
      <h2 style={{ color: 'white' }}>2. Uso de Licença</h2>
      <p style={{ color: 'white' }}>
        É concedida permissão para baixar temporariamente uma cópia dos
        materiais (informações ou software) no site guiathayde.dev, apenas para
      ...
      <ol style={{ color: 'white' }}>
        ...
        <li>
          ...
          contido no site guiathayde.dev;
        </li>
        <li>
      ...
      <p style={{ color: 'white' }}>
        ...
        dessas restrições e poderá ser rescindida por guiathayde.dev a qualquer
      ...
      <h2 style={{ color: 'white' }}>3. Isenção de responsabilidade</h2>
      <ol style={{ color: 'white' }}>
        <li>
          Os materiais no site da guiathayde.dev são fornecidos &apos;como
          estão&apos;. guiathayde.dev não oferece garantias, expressas ou
        ...
        <li>
          Além disso, o guiathayde.dev não garante ou faz qualquer representação
      ...
      <h2 style={{ color: 'white' }}>4. Limitações</h2>
      <p style={{ color: 'white' }}>
        Em nenhum caso o guiathayde.dev ou seus fornecedores serão responsáveis
        ...
        incapacidade de usar os materiais em guiathayde.dev, mesmo que
        guiathayde.dev ou um representante autorizado da guiathayde.dev tenha
      ...
      <h2 style={{ color: 'white' }}>5. Precisão dos materiais</h2>
      <p style={{ color: 'white' }}>
        Os materiais exibidos no site da guiathayde.dev podem incluir erros
        técnicos, tipográficos ou fotográficos. guiathayde.dev não garante que
        qualquer material em seu site seja preciso, completo ou atual.
        guiathayde.dev pode fazer alterações nos materiais contidos em seu site
        a qualquer momento, sem aviso prévio. No entanto, guiathayde.dev não se
        compromete a atualizar os materiais.
      </p>

      <h2 style={{ color: 'white' }}>6. Links</h2>
      <p style={{ color: 'white' }}>
        O guiathayde.dev não analisou todos os sites vinculados ao seu site e
        não é responsável pelo conteúdo de nenhum site vinculado. A inclusão de
        qualquer link não implica endosso por guiathayde.dev do site. O uso de
        qualquer site vinculado é por conta e risco do usuário.
      </p>

      <h3 style={{ color: 'white' }}>Modificações</h3>
      <p style={{ color: 'white' }}>
        O guiathayde.dev pode revisar estes termos de serviço do site a qualquer
        momento, sem aviso prévio. Ao usar este site, você concorda em ficar
        vinculado à versão atual desses termos de serviço.
      </p>

      <h3 style={{ color: 'white' }}>Lei aplicável</h3>
      <p style={{ color: 'white' }}>
        Estes termos e condições são regidos e interpretados de acordo com as
        leis do guiathayde.dev e você se submete irrevogavelmente à jurisdição
